...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BMCoin).toInt();
    ...
    fAutoRedeemBeepMagnet = settings.value("fAutoRedeemBeepMagnet", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemBeepMagnet:
            return fAutoRedeemBeepMagnet;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBeepMagnet: return "AutoRedeemBeepMagnet";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BMCoin).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBeepMagnet: {
            fAutoRedeemBeepMagnet = value.toBool();
            settings.setValue("fAutoRedeemBeepMagnet", fAutoRedeemBeepMagnet);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBeepMagnet() { return fAutoRedeemBeepMagnet; }
