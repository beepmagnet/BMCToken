...
QString TransactionRecord::getTypeLabel(const int &type)
{
    ...
    case RecvWithAddress:
        return BeepMagnetGUI::tr("Received with");
    case RecvFromOther:
        return BeepMagnetGUI::tr("Received from");
    case SendToAddress:
    case SendToOther:
        return BeepMagnetGUI::tr("Sent to");
    case SendToSelf:
        return BeepMagnetGUI::tr("Payment to yourself");
    case Generated:
        return BeepMagnetGUI::tr("Mined");
    case RecvBeepMagnet:
        return BeepMagnetGUI::tr("Received beepmagnet");
    case SendBeepMagnet:
        return BeepMagnetGUI::tr("Sent beepmagnet");
    case Other:
        return BeepMagnetGUI::tr("Other");
    default:
        return "";
    }
}
...
QString TransactionRecord::getTypeShort(const int &type)
{
    ...
    case TransactionRecord::RecvBeepMagnet:
        return "input";
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::SendBeepMagnet:
        return "output";
    default:
        return "inout";
    }
...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet *wallet, const CWalletTx &wtx)
{
    ...
    int64_t nCredOK, nCredBeepMagnet;
    wtx.GetCredit(nCredOK, nCredBeepMagnet, true);
    int64_t nCredit = nCredOK + nCredBeepMagnet;
    ...
    {
        if (nNet > 0 && nCredBeepMagnet > 0)
        {
            // -- credit
            TransactionRecord sub(hash, nTime, TransactionRecord::RecvBeepMagnet, "", "", nNet, 0);
        ...
        {
            // -- debit
            TransactionRecord sub(hash, nTime, TransactionRecord::SendBeepMagnet, "", "", nNet, 0);
        ...
        for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
        {
                ...
                && txout.IsAnonOutput())
            {
                ...
                if (wallet->HaveKey(ckidD))
                {
                    ...
                    sub.type = TransactionRecord::RecvBeepMagnet;
    ...
    } else
    {
        ...
        BOOST_FOREACH(const CTxIn& txin, wtx.vin)
        {
                ...
                && txin.IsAnonInput())
            {
                ...
                {
                    fAllFromMe = false;
                    break; // display as send/recv beepmagnet
                };
                continue;
            };
        ...
        if (fAllFromMe)
        {
            ...
            for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
            {
                    ...
                    && txout.IsAnonOutput())
                {
                    ...
                    sub.type = TransactionRecord::SendBeepMagnet;
                    sub.address = CBitcoinAddress(ckidD).ToString();
