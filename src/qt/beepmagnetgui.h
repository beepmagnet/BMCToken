...
/**
  BeepMagnet GUI main class. This class represents the main window of the BeepMagnet UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BeepMagnetGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit BeepMagnetGUI(QWidget *parent = 0);
    ~BeepMagnetGUI();
