...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "BeepMagnet - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "BeepMagnet Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the BeepMagnet debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the BeepMagnet help message to get a list with possible BeepMagnet command-line options.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_23->setText(QApplication::translate("RPCConsole", "Peer ID", 0));
        peerId->setText(QApplication::translate("RPCConsole", "N/A", 0));
        label_231->setText(QApplication::translate("RPCConsole", "Direction", 0));
