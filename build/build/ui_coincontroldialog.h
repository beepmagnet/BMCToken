...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 OK"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 OK"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 OK"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 OK"));
